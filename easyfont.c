...
static CHAR  *szFacename[4] = { "Tracker Digital",
...
BOOL EzfQueryFonts (HPS hps)
     ...
     for (sFace = 0 ; sFace <4 ; sFace++)
          {
          lRequestFonts = 0 ;
          lNumberFonts = GpiQueryFonts (hps, QF_PRIVATE|QF_PUBLIC, szFacename[sFace],
                                        &lRequestFonts, 0L, NULL) ;
          if (!lNumberFonts) continue;
          ...
          GpiQueryFonts (hps, QF_PRIVATE|QF_PUBLIC, szFacename[sFace],
